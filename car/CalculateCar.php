...
<body>
    ...
    if(isset($_GET['submit'])){
        ...
        if($car == "City" || $car == "Civic"){
            echo "<img width = '200px' src= images/logo-".strtolower($car).".png><br><br><br>";
            echo "<img width = '600px' src= images/$car.png></center>";
        }else {
            echo "<img width = '500px' src= images/logo-".strtolower($car).".png><br><br><br>";
            echo "<img width = '500px' src= images/$car.png></center>";
        }
        echo "</center>";
        echo "</td> <td>";
        echo "<fieldset>";
